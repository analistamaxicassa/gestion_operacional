...
if(!isset($_SESSION['userID']))
{
  ...
  }elseif (isset($_POST['centro_costo'],$_POST['fecha'],$_POST['variable'],$_POST['contador1']) && !empty($_POST['centro_costo']) && !empty($_POST['fecha']) && !empty($_POST['variable'])) {

    $sala = $_POST['centro_costo'];
    $fecha = $_POST['fecha'];
    $variable = $_POST['variable'];
    $contador_det = $_POST['contador1'];
      ...
      <div class="table-responsive">
        <table class="table table-bordered table-hover table-sm">
          ...
          <tbody>
            ...
            do {
             ...
             <tr class="<?php echo $color_fila; ?>">
               ...
               <td><button class="btn btn-info btn-lg" class="form-control" data-toggle='modal' data-target='#modal_detalle_<?php echo $contador_det."_".$contador; ?>' id="ver_detalle"><i class="fas fa-eye"></i></button></td>
               <?php if ($detalles_solicitud){ ?>
               <td><button class="btn btn-success btn-lg" class="form-control" data-toggle='modal' data-target='#detalle_hermes_<?php echo $contador_det."_".$contador; ?>' id="ver_detalle_sol"><i class="far fa-eye"></i></button></td>
             <?php }else{ ?>
               <td></td>
             <?php } ?>
               <td><button class="btn btn-primary btn-lg" class="form-control" data-toggle='modal' data-target='#seguimientos_<?php echo $contador_det."_".$contador; ?>' id="ver_seguimientos"><i class="fas fa-plus"></i></button></td>
             </tr>
           </tbody>
           <div class="modal fade bd-example-modal-lg" id="modal_detalle_<?php echo $contador_det."_".$contador; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="width:100%" >
             <div class="modal-dialog modal-lg" role="document" style="width:100%">
               <div class="modal-content">
                 ...
                 <div class="modal-footer">
                   <button type="button" class="btn btn-secundary" onclick="cerrar2(<?php echo $contador_det.",".$contador; ?>)">Cerrar</button>
                 </div>
               </div>
             </div>
           </div>
           ...
           <?php   if (!empty($resul_datos)) { ?>

           <div class="modal fade bd-example-modal-lg" id="detalle_hermes_<?php echo $contador_det."_".$contador; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="width:100%" >
             <div class="modal-dialog modal-lg" role="document" style="width:100%">
               <div class="modal-content">
                 <div class="modal-header">
                 ...
                 <div class="modal-footer">
                   <button type="button" class="btn btn-secundary" onclick="cerrar_det_sol(<?php echo $contador_det.",".$contador; ?>)">Cerrar</button>
                 </div>
               </div>
             </div>
           </div>
         <?php } ?>
           ...
           <div class="modal fade bd-example-modal-lg" id="seguimientos_<?php echo $contador_det."_".$contador; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="width:100%" >
             <div class="modal-dialog modal-lg" role="document" style="width:100%">
               <div class="modal-content">
                 <div class="modal-header">
                 ...
                 <div class="modal-footer">
                   ...
                   <button type="button" class="btn btn-secundary" onclick="cerrar_mod_segui(<?php echo $contador_det.",".$contador; ?>)">Cerrar</button>
                 </div>
               </div>
             </div>
           </div>
