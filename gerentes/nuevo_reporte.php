...
<div class="container">
                ...
                <div class="panel-body">
                    <div class="row">
                      <div class="col-md-3">
                        ...
                        <input type="date" id="fecha_visita" name="fecha_visita" value="<?php echo $fecha_inspeccion; ?>" class="form-control">
                      </div>
                      <div class="col-md-4">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        <label><strong>Tema(s) a revisar:</strong></label>
                        <div id="tema_revisar"></div>
                        <input type="hidden" id="contador">
                      </div>
                      <div class="col-md-3" id="divauditoria" style="display:none;">
                        <label for="nota"><strong>Se realizó:</strong></label>
                        <select class="form-control" id="auditoria" name="auditoria">
                          <option value="">Seleccione</option>
                      ...
                      <div class="col-md-4">
                        <div id="divform" class="form-group" enctype="multipart/form-data">
                          <form id="form" action="" enctype="multipart/form-data" method="post">
                            <input type="file" id="file_adjunto" name="file_adjunto"  onchange="return fileValidacion()">
                          </form>
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="col-md-4">
                        <div id="divform1" class="form-group" enctype="multipart/form-data">
                          <form id="form1" action="" enctype="multipart/form-data" method="post">
                            <input type="file" id="file_adjunto_1" name="file_adjunto_1"  onchange="return fileValidacion1()">
                          </form>
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="col-md-4">
                        <div id="divform2" class="form-group" enctype="multipart/form-data">
                          <form id="form2" action="" enctype="multipart/form-data" method="post">
                            <input type="file" id="file_adjunto_2" name="file_adjunto_2"  onchange="return fileValidacion2()">
                          </form>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-md-3">
                        <button class="btn btn-info btn-lg" class="form-control" style="margin-top:25px;" data-toggle='modal' data-target='#modal' id="crear_solicitud" ><i class="fas fa-plus"></i> Crear Solicitud</button>
                      </div>
                      <div class="col-md-2">
                        <label for="cod_hermes">Código Hermes:</label>
                        <input type="number" class="form-control" id="cod_hermes" name="cod_hermes">
                      </div>
                      <div class="col-md-3 offset-md-2">
                        <button class="btn btn-primary btn-lg" name="enviar" style="margin-top:25px;" onclick="guardar_gestion();" ondblclick="this.disabled='disabled'" id="guardar_gestion" >Guardar Gestión</button>
                      </div>
                    </div>
                </div>
            </div>
    ...
    <div class="row">
      ...
      $sql_seguimientos = "SELECT gs.codigo_gestion, gs.centro_costo,gs.fecha_inspeccion,gs.cod_variable,pa.Descripcion as nom_variable ,gs.cod_concepto,vc.descripcion_con as nom_concepto,
                            gs.cod_tema,gs.calificacion,gs.hallazgo,gs.acciones,gs.fecha_control,gs.estado_gestion,para.Descripcion as nom_estado,gs.cod_sol_hermes,gs.observacion
