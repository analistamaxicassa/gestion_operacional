                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="alert alert-info" role="alert">
                        Para los <strong>administradores de sala</strong>, ingrese al siguiente <a href="http://190.144.42.83:81/auditoria_operacional/vista_sala/index.php" class="alert-link">LINK</a> para ingresar a la plataforma.
                      </div>
                    </div>
                  </div>
                </fieldset>
