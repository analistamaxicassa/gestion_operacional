  	  ...
  	  <div class="container-fluid">
  	    ...
  	    <div class="collapse navbar-collapse" id="myNavbar">
  	      <ul class="nav navbar-nav navbar-right">
  	        <li><a href="../logout.php?origen=1" id="a02"><span class="glyphicon glyphicon-log-out"></span><strong> Cerrar Sesión</strong></a></li>
  	      </ul>
  	    </div>
  	  </div>
  	</nav>
  	<iframe id="principal"  name="principal"  src="inicio.php" style="margin-top:0px; overflow: hidden; width: 100%; position: relative;"  frameborder="0" height="1000"></iframe>
  </body>
</html>
