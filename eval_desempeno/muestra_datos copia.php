...
<table width="90%" border="1" align="center">
      ...
      <tr>
        <th width="8%" scope="col">Nombre del Evaluado</th>
        <th width="34%" colspan="1" scope="col"><label for="nombre"></label>
        ...
        <th width="21%" scope="col">Cargo del Evaluado</th>
        <th colspan="3" scope="col"><label for="codcargo"></label>
        <input name="codcargo" type="text" id="codcargo" size="5" align="left" value="<?php echo utf8_encode($row1['CARGO_CODIGO']); ?>">          <input name="cargo" type="text" id="cargo" value=" <?php echo utf8_encode($row1['CARGO_NOMBRE']); ?>" size="50" readonly></th>
      </tr>
      <tr>
        ...
        <th colspan="3" scope="col"  align="left"><label>
          <input type="text" name="tiempo_vinculacion" id="tiempo_vinculacion">
        </label></th>
      </tr>
      <tr>
    ...
    <table width="90%" border="0" align="center">
      <tr>
                    ...
                    <td width="539" class="encabezados">ASPECTOS </td>
                    <td colspan="2" class="encabezados">DEFINICIONES</td>
                    <td width="120" class="encabezados">&nbsp;</td>
                    <td width="195" class="encabezados">PROMEDIO</td>
                   
      </tr>
                  <tr>
             <?php
 $sql4 = "SELECT id, aspecto, definicion FROM `ed_def_aspectos` group by aspecto order by id" ;
    ...
    <tr>
     ...
     <input name="operacion<?php echo utf8_encode($rs_qry3->id); ?>" type="text" value="<?php echo utf8_encode($rs_qry3->operacion); ?>" size="80" readonly></td>
      <td width="130" align="left" valign="middle"><select name="valoracion<?php echo utf8_encode($rs_qry3->id); ?>"/>
      
        <option value="">...</option>
        <option value="0.25">NUNCA</option>
        <option value="0.50">ALGUNAS VECES</option>
