...
where rownum = 1";
		...
		$AUS_CONSECUTIVO = $row_n1['AUS_CONSECUTIVO']+1;
		 ...
		 $query11 = "SELECT EM.EMP_TIPO_NOMINA
        FROM EMPLEADO EM
        WHERE EM.EMP_CODIGO = '$EMP_CODIGO'";
		$stmt11 = $dbh->prepare($query11);
		$stmt11->execute();
		$row_n11 = $stmt11->fetch();
		
	$tipo_nomina = $row_n11['EMP_TIPO_NOMINA']; 
	...
	echo $sql5="Insert into TRH_AUSENTISMO
 ...
 Values
    ...
    TO_DATE('$AUS_FECHA_INICIAL', 'mm/dd/yyyy HH24:MI:SS'), TO_DATE('$AUS_FECHA_INICIAL', 'mm/dd/yyyy HH24:MI:SS'),
	 $UNIDADES, TO_DATE('$AUS_FECHA_INICIAL', 'mm/dd/yyyy HH24:MI:SS'), 'ACT', 
    NULL, NULL, NULL, NULL, '$AUS_OBSERVACION1',NULL, NULL,'SRHCATERIN',TO_DATE('$hoy', 'mm/dd/yyyy HH24:MI:SS'), NULL, 
    0)";
