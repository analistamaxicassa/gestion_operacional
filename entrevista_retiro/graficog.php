    ...
    $('#container').highcharts({
        ...
        xAxis: {
			...
			<?php
				...
				$sql=mysql_query("SELECT `bloque4`, count(bloque4) qbloque4 FROM `entrevista_retiro` WHERE mes $mes and motivo = 'RENUNCIA' group by bloque4 order by count(bloque4) desc ");
				while($res=mysql_fetch_array($sql)){			
			
?>					
			
			['<?php echo $res['bloque4']; ?>'],
<?php
}
?>
			]
