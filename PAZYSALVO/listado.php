...
$arealis=$_POST['area'];
//funcion fechas
require_once("../PAZYSALVO - copia/FuncionFechas.php");
require_once('../PAZYSALVO - copia/conexion_ares.php'); 
$link=Conectarse();
$hoy=date("Y-m-d");
...
<body>
<form method="post" action="../PAZYSALVO - copia/web_contacto.php">
...
<br>
  <table width="982" border="3" align="left" style="font-size: 14px;"  >
    ...
    <tr>
      <td width="111"><A href="../PAZYSALVO/pazysalvomostrar.php?cedula=<?php echo $cedula;?>"> <?php echo $cedula; ?></A></td>
