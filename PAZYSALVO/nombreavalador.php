...
//consulta nombre de avalador
	/*	$query = "SELECT  EM.EMP_NOMBRE||' '||EM.EMP_APELLIDO1||' '||EM.EMP_APELLIDO2 					                   	avalador FROM EMPLEADO EM WHERE EM.EMP_CODIGO = '$avaladorXX'";
		$stmt = $dbh->prepare($query);
		$stmt->execute();
		$row_aval = $stmt->fetch();
		//$nomaval1 = $row_aval['avalador'];
		$nomaval1 = 'LILIANA RODRIGUEZ ALVAREZ';  ///temporal mientras arregla conexion con queryx
...
<form method="post" action="pazysalvoVB.php">
