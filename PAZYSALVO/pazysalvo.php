...
switch($certificado)
{
	...
	if (@$rs_qry->fsolicitud=="")
	{
		...
		Por favor dirijase a la plataforma de ares para realizar su respectiva autorizacion http://10.1.0.22/ares o  http://190.144.42.83/ares/		        <br>	
		GRACIAS<br>
		</center>';
		...
		echo $row_n['NOMBRE'];
			...
			$mail->SetFrom('ares@ceramigres.com', 'Depto. de Gestion Humana');	
...
//	if (pego == 1)
	...
	//Evalua si el empleado tiene elementos a Cargo 

$sql2="SELECT `descripcion_elemento`, observacion,`cantidad`,`ubicacion`, nombre, `condicion`
...
WHERE  ec.cedula = '$cedula'
order by ubicacion ";
			$qry_sql2=$link->query($sql2);
			$rs_qry2=$qry_sql2->fetch_object();  ///consultar 


		if ($rs_qry2->cantidad == 0)
		{
			$mensaje = "";
			}
	    else
		{
		 $mensaje =  "EL EMPLEADO AUN NO HA ENTREGADO SUS ELEMENTOS DE TRABAJO, POR FAVOR VERIFIQUE ANTES DE GENERAR EL PAZ Y SALVO";
		}
	...
	$vb_tucassa = $rs_qry->vb_tucassa;
	$obs_vb_tucassa = $rs_qry->obs_vb_tucassa;
	$usu_vb_tucassa = $rs_qry->usu_vb_tucassa;
	$vb_socupacional = $rs_qry->vb_socupacional;
	$obs_vb_socupacional = $rs_qry->obs_vb_socupacional;
	$usu_vb_socupacional = $rs_qry->usu_vb_socupacional;
	$vb_suministros = $rs_qry->vb_suministros;
	$obs_vb_suministros = $rs_qry->obs_vb_suministros;
	$usu_vb_suministros = $rs_qry->usu_vb_suministros;
...
<table>
 <tr>
      <td colspan="7" align="center" valign="middle"  bgcolor="#CCCCCC"  style="color:#F00" ><label><strong><?php echo $mensaje; ?></strong></label></td>
    </tr>
</table>
  ...
  <table width="830" border="3" align="left">
    ...
    <tr>
      <td colspan="7" align="center" bgcolor="#CCCCCC"><em><strong>8. CONCEPTO CONTABILDIAD TU CASSA</strong></em></td>
    </tr>
    <tr>
      <td colspan="3" bgcolor="#FFFFFF">F. Respuesta</td>
      <td bgcolor="#FFFFFF"><?php echo $vb_tucassa; ?></td>
      <td colspan="3" bgcolor="#FFFFFF">Vb.<?php echo $usu_vb_tucassa; ?></td>
    </tr>
    <tr>
      <td colspan="3" bgcolor="#FFFFFF">Observaciones</td>
      <td colspan="4" bgcolor="#FFFFFF"><textarea name="obs8" cols="130" id="obs8"><?php echo $obs_vb_tucassa; ?></textarea></td>
    </tr>
    <tr>
   ...
   <tr>
    ...
    <tr>
      ...
      <textarea name="obs10" cols="130" id="obs10"> <?php echo $obs_vb_socupacional; ?></textarea><label for="obs10"></label></td>
    </tr>
    ...
    <tr>
      ...
      <textarea name="obs11" cols="130" id="obs11"><?php echo $obs_vb_suministros; ?></textarea><label for="obs11"></label></td>
    </tr>
    ...
    <tr>
      ...
      <textarea name="obs12" cols="130" id="obs12"><?php echo $obs_vb_containno; ?></textarea></td>
    </tr>
    <tr bgcolor="#CCCCCC">
    ...
    <tr>
      <td height="25" colspan="7">Concepto de Nomina:</td>
    </tr>
