...
<table width="982" border="3" align="left">
    ...
    <tr>
      ...
      <td colspan="3"><label for="cedula">Centro de costos</label></td>
      <td width="186" bgcolor="#B6BCC3">Nombre</td>
      <td width="126" align="center">Cargo</td>
      <td width="142" align="center">Centro de Costo</td>
      <td width="126" align="center">Motivo</td>
      <td width="120" align="center">Fecha Retiro</td>
    </tr>
    </table>
...
<?php
	...
	$mensaje1 = "";
        ...
        CC.CENCOS_NOMBRE CC,  (SUBSTR(EM.EMP_CC_CONTABLE,4,3)) CODCC, EM.EMP_FECHA_INI_CONTRATO
...
<br>
  <table width="982" border="3" align="left" style="font-size: 14px;"  >
    <tr>
      ...
      <td width="128"><img id="myImage" onClick="gsalae( <?php echo $cedula; ?>, <?php echo $row_n['CODCC']; ?> )" src="../PAZYSALVO/img/utiles.png"  width="99" height="49" alt="Herramientas Asignadas" /></a></td>
