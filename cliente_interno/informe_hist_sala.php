...
<table width="90%" border="1" align="center" cellpadding="0" cellspacing="0" class="header" >
  <tr class="encabezados">
    <th width="35%" scope="row">CONCEPTO</th>
    <td width="8%" class="header">CALIFICACION</td>
    <td width="21%" class="header">HALLAZGO</td>
    <td width="20%">TAREA</td>
    <td width="16%">RESPONSABLE</td>
     <td width="16%">FECHA DE CONTROL</td>
      <td width="16%"></td>
     </tr>
  <tr>
    <th scope="row"> <select name="concepto_det" id="concepto_det">
    ...
    <td><textarea name="hallazgo" cols="5" rows="4"  id="hallazgo"></textarea></td>
    <td><textarea name="tarea" cols="5" rows="4" id="tarea"></textarea></td>
