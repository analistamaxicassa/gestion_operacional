...
$link=Conectarse();
	...
	//conexion sql	
			...
			$sql="SELECT * FROM permisos where autoriza = '$cedula' and `aut_jefe` is null";
	...
	if ($tausentismo == '11')  { $motivo = 'PERMISO REMUNERADO';}
...
<script>
 ...
 function confirmar (cedula, f_solicitud, jefe, observacion, f_permiso, motivo, unidades, correoemp, tipo)
        {			
				var parametros = {
				"cedula": cedula,
 ...
 function denegar(cedula, correoemp)
...
<table width="100%" border="0" cellpadding="0" cellspacing="0"><tr>
  ...
  <table width="884" border="1" align="center" style="border-collapse: collapse; font-size: 12px;">
    <tr class="encabezados">
      <td class="encabezados" width="336" height="40" align="center"  valign="middle" ><?php echo $row_n['SOCIEDAD']; ?>&nbsp;</td>
      <td colspan="2"  class="encabezados" align="center"> <strong>SOLICITUD DE PERMISO</strong></td>
    </tr>
    <tr>
    ...
    <tr>
      <td height="30" colspan="2"  class="text">FECHA DE SOLICITUD 
      ...
      <td  class="text">FECHA DE PERMISO
      <input name="f_permiso" type="text" required  class="text" id="f_permiso"  value="<?php echo $f_permiso; ?>" readonly /></td>
    </tr>
    <tr>
      <td height="30" colspan="2"  class="text">HORA DE SALIDA
        <label for="salida"></label>
        <input name="salida" type="text" id="salida" value="<?php echo $salidafor; ?>" readonly /></td>
      <td  class="text"><div id="validador">HORA DE LLEGADA 
          <label for="llegada"></label>
            <input name="llegada" type="text" id="llegada2"  value="<?php echo $llegadafor; ?>" readonly  />
      </div></td>
    </tr>
    <tr>
      <td height="30" colspan="3"  class="text"><div id="respuesta">MOTIVO DE PERMISO :      
          <label for="motivo"></label>
          <label for="motivo2"></label>
          <input name="motivo" type="text" id="motivo2" value="<?php echo $motivo; ?>" readonly />
      </div></td>
    </tr>
    <tr>
      <td height="30" colspan="3" bgcolor="#CCCCCC"  class="text">OBSERVACION:</td>
    </tr>
    <tr>
      <td height="30" colspan="3"  class="text"><label for="observacion"></label>
      <input name="observacion" type="text" id="observacion" value="<?php echo $observacion; ?>" size="140" readonly /></td>
    </tr>

    <tr>
      <td colspan="2"><input name="restablecer" type="reset" class="botones" id="restablecer"
       onClick="confirmar ($('#cedula').val(),$('#f_solicitud').val(),('<?php echo $jefe;?>'),('<?php echo utf8_encode($observacion);?>'),$('#f_permiso').val(),('<?php echo $tausentismo;?>'),('<?php echo $unidades;?>'),('<?php echo $correoemp;?>'),('<?php echo $tipo;?>')); return false;" value="AUTORIZAR"/></td>
      <td><input name="denegar" type="submit" class="botones" id="denegar" onClick="denegar($('#cedula').val(),('<?php echo $correoemp;?>')); return false;" value="NEGAR PERMISO"  /></td>
