...
#login {
 ...
 function actualizar_resp(actual, nuevo, cedulaingreso) 
        {	
    ...
    <td>
        <div class="formulario" id="login" style="margin-top: 40px"> 
          ...
          <p><br>
            ...
            <input name="resp_actual" type="text" id="resp_actual" onChange="llenaractual(this.value);" size="15"/>
...
<center>
<div id="validadorbuscar" style="font-family:Verdana, Geneva, sans-serif; width:50%; text-align:center">
