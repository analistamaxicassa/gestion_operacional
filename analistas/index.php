              ...
              <form role="form" action="../validar_usuario.php" method="post">
                <fieldset>
                  <div class="form-group">
                    <!-- <label for="usuario">Ingreso auditoria operacional:</label> -->
                    <div class="row">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="alert alert-info" role="alert">
                        Para los <strong>administradores de sala</strong>, ingrese al siguiente <a href="http://200.122.250.67:8181/gestion_operacional/vista_sala/index.php" class="alert-link">LINK</a> para ingresar a la plataforma.
                      </div>
                    </div>
                  </div>
                </fieldset>
