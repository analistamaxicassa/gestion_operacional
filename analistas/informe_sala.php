...
// cantidad de empleados en capacitacion detallando cargo
  ...
  */
  ...
  INNER JOIN salas ON cs.cc = salas.cc WHERE cs.cc = '$sala' GROUP BY cs.fecha, salas.nombre ORDER BY cs.fecha DESC";
...
<html lang="es">
  ...
  <div class="col-md-8 col-md-offset-2">
    <div class="btn-group btn-group-justified btn-group-lg my-btn-group-responsive">
      ...
      <a type="button" class="btn btn-primary" href="nuevo_reporte.php?sala=<?php echo $sala; ?>">Reportes sala</a>
