...
<body>
    ...
    <header>
       ...
       <tr style="background-color:transparent">
         ...
         <td width="50%" align="center" valign="middle"><div style="font-family:Verdana, Geneva, sans-serif; font-size:8px; width:600px; height:60px; text-align:center" class="intro_tk">
     <br> <br> <br>
     <b style="color: #333; font-size: 14px;">CLIENTE INTERNO</b></div>
    </td>
         <td align="right">
