...
AND EM.EMP_CODIGO = '1048275266' and AC.ACUM_FECHA_PAGO > (sysdate - 365)";
...
<br>
  ...
  por valor de $<b><?php echo number_format($salario,0,",","."); ?></b> , recibe un auxilio de alimentacion promedio no constitutivo al
  salario ni factor prestacional de $<b><?php echo number_format($total,0,",","."); ?></b></p>
<p>&nbsp;</p>
