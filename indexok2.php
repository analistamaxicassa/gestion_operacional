 ...
 <tr>
    <td>
        <div id="login" style="margin-top:40px; text-align:left"> 
          ...
          <p align="center" style="color:#039"><b>Sin sucesion</b>
          ...
          <p align="center"><input type="button" value="Generar certificado" onclick="generar($('#cedula').val(),  $('#sucesion').val(), $('#valorcesantias').val(), $('#destinocesantias').val()); return false;"/></p>
