...
if($_SESSION['us'] == '1') {
	...
	location.href="informe_sala.php?sala=<?php echo $sala?>"
...
<h2>ACTUALIZACION DE DATOS PERSONALES</h2>
  <div>
	...
	<A href="informe_sala.php?sala=<?php echo utf8_encode($rs_qry1->sala);?>">REGRESAR</A>
    
         <tr>
           <td height="27" colspan="4" align="left" valign="middle" class="encabezados"><strong>SalaXXXXXXXX</strong></td>
