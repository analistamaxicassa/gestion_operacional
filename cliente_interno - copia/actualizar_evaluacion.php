  ...
  <div>
   ...
   <table border="1" style="border-collapse:collapse; border:#69F solid 1px; font-family:Verdana, Geneva, sans-serif; font-size:10px " width="80%" height="82%">
    <tr>
      ...
      <input name="evaluador" type="text" id="evaluador" size="100"></td>      </tr> 
 <tr>
      ...
      <input type="text" name="nota" id="nota"></td>  
     </tr>
      <tr>
      ...
      <td width="612" colspan="6" align="justify" bgcolor="#999999" valign="middle" class="header"><input name="ap_conocimiento" type="text" id="ap_conocimiento" size="100" ></td> 
     </tr>
      <tr>
        <td class="header" align="left" valign="middle">Estudios</td>
        <td width="612" colspan="6" align="justify" bgcolor="#999999" valign="middle" class="header"><input name="ap_estudios" type="text" id="ap_estudios" size="100" ></td>
      </tr>
      <tr>
        <td class="header" align="left" valign="middle">Presentacion</td>
        <td width="612" colspan="6" align="justify" bgcolor="#999999" valign="middle" class="header"><input name="ap_presentacion" type="text" id="ap_presentacion" size="100" ></td>
      </tr>
      <tr>
      ...
      <td width="612" colspan="6" align="justify" bgcolor="#999999" valign="middle" class="header"><input name="horarios" type="text" id="horarios" size="100" ></td> 
     </tr>
      <tr>
        <td class="header" align="left" valign="middle">Colaboracion</td>
        <td width="612" colspan="6" align="justify" bgcolor="#999999" valign="middle" class="header"><input name="colaboracion" type="text" id="colaboracion" size="100" ></td>
      </tr>
    <tr>
